...
async function getJetSki(slug: string) {
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const jetski = await getJetSki(slug)
        ...
        <section className="section-padding bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-6xl mx-auto">
              ...
              <div>
                {intro.title && (
                  <h2 className="heading-2 text-gray-900 mb-5">{intro.title}</h2>
                )}
                {intro.description && (
                  <p className="text-gray-600 leading-relaxed text-base lg:text-lg">{intro.description}</p>
                )}
                <div className="mt-8">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                ...
                {specs.title && <h2 className="heading-2 text-gray-900 mb-4">{specs.title}</h2>}
                {specs.subtitle && <p className="text-lg text-gray-500">{specs.subtitle}</p>}
              </div>
                ...
                {specs.rows.map((row, index) => (
                  <div
                    ...
                    className={cn(
                      ...
                      index !== specs.rows!.length - 1 && 'border-b border-gray-100'
                    )}
                  >
        ...
        <section className="section-padding bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              {gallery.title && <h2 className="heading-2 text-gray-900 mb-4">{gallery.title}</h2>}
              {gallery.subtitle && <p className="text-lg text-gray-500">{gallery.subtitle}</p>}
            </div>
        ...
        <section className="relative overflow-hidden">
          <div className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-950 py-20 lg:py-24">
            ...
            <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              {cta.subtitle && (
                <p className="text-primary-200 text-lg mb-10 max-w-xl mx-auto">{cta.subtitle}</p>
              )}
              <Button
                asChild
                size="xl"
